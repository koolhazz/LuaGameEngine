...
static int tolua_collect_CMemcachedHandler (lua_State* tolua_S)
{
 CMemcachedHandler* self = (CMemcachedHandler*) tolua_tousertype(tolua_S,1,0);
	Mtolua_delete(self);
	return 0;
}
#endif
...
{
 tolua_usertype(tolua_S,"CMemcachedHandler");
}
...
/* method: new of class  CMemcachedHandler */
#ifndef TOLUA_DISABLE_tolua_interface_mc_CMemcachedHandler_new00
static int tolua_interface_mc_CMemcachedHandler_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"CMemcachedHandler",0,&tolua_err) ||
...
#endif
 {
  const string host = ((const string)  tolua_tocppstring(tolua_S,2,0));
  {
   CMemcachedHandler* tolua_ret = (CMemcachedHandler*)  Mtolua_new((CMemcachedHandler)(host));
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"CMemcachedHandler");
...
/* method: new_local of class  CMemcachedHandler */
#ifndef TOLUA_DISABLE_tolua_interface_mc_CMemcachedHandler_new00_local
static int tolua_interface_mc_CMemcachedHandler_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: delete of class  CMemcachedHandler */
#ifndef TOLUA_DISABLE_tolua_interface_mc_CMemcachedHandler_delete00
static int tolua_interface_mc_CMemcachedHandler_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"CMemcachedHandler",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
...
/* method: Get of class  CMemcachedHandler */
#ifndef TOLUA_DISABLE_tolua_interface_mc_CMemcachedHandler_Get00
static int tolua_interface_mc_CMemcachedHandler_Get00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
  {
   string tolua_ret = (string)  self->Get(key);
...
/* method: Set of class  CMemcachedHandler */
#ifndef TOLUA_DISABLE_tolua_interface_mc_CMemcachedHandler_Set00
static int tolua_interface_mc_CMemcachedHandler_Set00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const string value = ((const string)  tolua_tocppstring(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'Set'", NULL);
#endif
  {
   int tolua_ret = (int)  self->Set(key,value);
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)key);
...
TOLUA_API int tolua_interface_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"mc");
   #ifdef __cplusplus
   tolua_cclass(tolua_S,"CMemcachedHandler","CMemcachedHandler","",tolua_collect_CMemcachedHandler);
   #else
   tolua_cclass(tolua_S,"CMemcachedHandler","CMemcachedHandler","",NULL);
   #endif
   tolua_beginmodule(tolua_S,"CMemcachedHandler");
    tolua_function(tolua_S,"new",tolua_interface_mc_CMemcachedHandler_new00);
    tolua_function(tolua_S,"new_local",tolua_interface_mc_CMemcachedHandler_new00_local);
    tolua_function(tolua_S,".call",tolua_interface_mc_CMemcachedHandler_new00_local);
    tolua_function(tolua_S,"delete",tolua_interface_mc_CMemcachedHandler_delete00);
    tolua_function(tolua_S,"Get",tolua_interface_mc_CMemcachedHandler_Get00);
    tolua_function(tolua_S,"Set",tolua_interface_mc_CMemcachedHandler_Set00);
   tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
 tolua_endmodule(tolua_S);
 return 1;
